        ...
        <div class="card-body">
            <div class="w-100 align-items-center justify-content-between mb-4 d-flex row">
                ...
                <div class=" col-md-5 col-12 my-3 d-flex">
                    ...
                    <a class="bl_btn align-items-center d-flex justify-content-center mb-0 mx-0 w-100" href="<?php echo e(route('export-orders')); ?>">Download Excel</a>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\priv\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>