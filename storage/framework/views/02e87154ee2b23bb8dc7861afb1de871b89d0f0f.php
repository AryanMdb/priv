        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="w-100 align-items-center justify-content-between mb-4 d-flex">
                    <h4 class="card-title">New Slider Create</h4>
                </div>
                ...
                <form id="addSlider" class="forms-sample" method="POST" action="<?php echo e(route('sliders.store')); ?>"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1290354.cloudwaysapps.com/bhqcygtvak/public_html/resources/views/admin/sliders/create.blade.php ENDPATH**/ ?>