                                    ...
                                    <div class="row delivery-charge-row">
                                        ...
                                        <div class="col-md-3 col-6 pl-0">
                                            <div class="form-group flex-column d-flex">
                                                <label for="title">&nbsp;</label>
                                                <a href="javascript:void(0);" style="width:fit-content" class="btn btn-danger mr-2 remove-row">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\The Mad Brains\priv\resources\views/admin/category/edit.blade.php ENDPATH**/ ?>