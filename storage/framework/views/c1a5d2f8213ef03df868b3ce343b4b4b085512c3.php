        ...
        <div class="w-100 align-items-center justify-content-between mb-4 d-flex row">
            ...
            <div class="col-xl-7 col-md-12 col-12 w-100 d-flex justify-content-end mt-3">
                <div class="d-flex w-100">
                    <form class="w-100 mr-1" method="GET" action="#" id="searchForm">
                        <input class="form-control" type="search" name="search" id="search" placeholder="Search Orders"
                    ...
                    <a class="bl_btn align-items-center d-flex justify-content-center mb-0 mx-0 w-100"
                        href="<?php echo e(route('export-orders')); ?>">Download Excel</a>
                        ...
                        <td>
                            <form action="<?php echo e(route('order.assign-subadmin', $order->id)); ?>" method="POST"
                                ...
                                <select class="assign_subadmin w-100" name="role_id[]" multiple="multiple">
                                    ...
                                    <option value="<?php echo e($role->id); ?>" <?php echo e(in_array($role->id, (array)
                                        json_decode($order->role_id)) ? 'selected' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\The Mad Brains\messho\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>