    ...
    <div class="card col-12">
        <div class="card-body">
            <div class="w-100 align-items-center justify-content-between mb-4 row">
                ...
                <div class="col-md-6 col-12 w-100 d-flex mt-3">
                        <div class="d-flex w-100">
                            ...
                            <!-- Entries Form -->
                            <form class="w-100 mx-1" method="GET" action="<?php echo e(route('product.index')); ?>">
                                <label for="entries">Table Entries</label>
                    ...
                    <div class="col-md-12 col-12 w-100 justify-content-end d-flex mt-4">
                        <a class=" bl_btn mb-0 mr-3" href="<?php echo e(route('products.export')); ?>">Download Excel</a>
                        <a class=" bl_btn mb-0" href="<?php echo e(route('product.create')); ?>">Add Product</a>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1290354.cloudwaysapps.com/bhqcygtvak/public_html/resources/views/admin/product/index.blade.php ENDPATH**/ ?>