            ...
            <div class="w-100 align-items-center justify-content-between mb-4 d-flex row">
                ...
                <div class="col-xl-7 col-md-12 col-12 w-100 d-flex justify-content-end mt-3">
                    <div class="d-flex w-100">
                        <form class="w-100 mr-1" method="GET" action="<?php echo e(route('vendor.index')); ?>" id="searchForm">
                        ...
                        <form class="mr-3 w-100" method="GET" action="<?php echo e(route('vendor.index')); ?>">
                        ...
                        <a class="bl_btn align-items-center d-flex justify-content-center mb-0 mx-0 w-100"
                            href="<?php echo e(route('vendor.create')); ?>">Add New Vendor</a>
            ...
            <div class="table-responsive">
                <table class="table table-striped" id="table">
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($i++); ?></td>
                                ...
                                <td>
                                    <form action="<?php echo e(route('vendor.switch.toggle')); ?>" method="POST" style="height: 34px;">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\The Mad Brains\priv\resources\views/admin/vendors/index.blade.php ENDPATH**/ ?>