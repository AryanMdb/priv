<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
          ...
          <h5 class="mb-0 font-weight-medium d-none d-lg-flex header-title">Welcome <strong style="color:#03ac51;padding:0 5px; text-transform:uppercase;"> Privykart </strong><?php echo e(auth()->user()->roles->first()->name); ?>!</h5>
            ...
            <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center px-0">
                  <a href="<?php echo e(route('changepassword')); ?>"><p class="mb-1 mt-3 text-capitalize" id="userName">Change Password</p></a>
      ...
      </nav><?php /**PATH /home/1290354.cloudwaysapps.com/bhqcygtvak/public_html/resources/views/subadmin/layouts/header.blade.php ENDPATH**/ ?>