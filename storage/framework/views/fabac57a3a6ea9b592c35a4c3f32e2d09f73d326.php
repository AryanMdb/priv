    ...
    <div class="card-body">
        <div class="w-100 align-items-center justify-content-between mb-4 d-flex row">
            ...
            <div class=" col-md-6 col-6 my-3">
                <form class="mx-3 w-100" method="GET" action="<?php echo e(route('subcategory.index')); ?>">
            ...
            <div class="col-md-12 col-6 justify-content-end d-flex">
                <a class="bl_btn mb-0" href="<?php echo e(route('subcategory.create')); ?>">Add Sub Category</a>
            </div>
        </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1290354.cloudwaysapps.com/bhqcygtvak/public_html/resources/views/admin/subcategory/index.blade.php ENDPATH**/ ?>