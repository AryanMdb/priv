                                        ...
                                        <div class="table-responsive">
                                            <div class="data">
                                                <table class="table table-striped" id="table">
                                                    ...
                                                    <tr>
                                                        <th>Location</th>
                                                        <td><a href="#" id='location' data-toggle="modal"
                                                                data-target="#mapModal">{{ $address ?? '-'}}</a></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{
                                                            \Carbon\Carbon::parse($order->date_of_journey)->format('m/d/Y')
                                                            ?? '-'}}</td>
                                                    </tr>
                                                    @endif
                                                    @if($order->time_of_journey != '' && $order->time_of_journey !=
                                                    '00:00:00')
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <th>Order Date</th>
                                                        <td>@isset($order->created_at)@endisset{{ date('d M Y',
                                                            strtotime($order->created_at)) }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th>Order Time</th>
                                                        <td>@isset($order->created_at)@endisset{{ date('h:i A',
                                                            strtotime($order->created_at)) }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th>Status</th>
                                                        <td>
                                                            ...
                                                            <button type="button"
                                                                class="btn btn-success btn-sm switch_toggle_button"
