                    ...
                    <div class="col-md-12">
                        ...
                        @else
                            <div class="img-upload  mb-5">
                                <fieldset class="form-group file-upload-link">
                                    <a href="javascript:void(0) file-upload-link" onclick="$('#pro-image').click()">Upload Images</a>
                                    <input type="file" id="pro-image" name="image[]" style="display: none;"
                                        class="form-control file" multiple>
                                </fieldset>
                                <div class="preview-images-zone ui-sortable">
                        ...
                        @foreach($product_inventory as $inventoryItem)
                            <div class="dynamicRow">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-5">
                                        <input type="text" class="form-control numeric" name="inventory[{{ $i }}][price]"
                                            placeholder="Price (₹)" value="{{ $inventoryItem['price'] }}">
                                    </div>
                                    <div class="col-2">
    ...
    $(document).ready(function () {
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.image-cancel', function () {
                ...
                togglePreviewZoneVisibility(); // Update preview visibility after an image is removed
            });

            // Check if the preview zone should be visible when the page loads
