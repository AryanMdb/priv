            ...
            <div class="w-100 align-items-center justify-content-between mb-4 d-flex row">
                ...
                <div class="col-xl-7 col-md-12 col-12 w-100 d-flex justify-content-end mt-3">
                    <div class="d-flex w-100">
                        <form class="w-100 mr-1" method="GET" action="{{ route('vendor.index') }}" id="searchForm">
                        ...
                        <form class="mr-3 w-100" method="GET" action="{{ route('vendor.index') }}">
                        ...
                        <a class="bl_btn align-items-center d-flex justify-content-center mb-0 mx-0 w-100"
                            href="{{ route('vendor.create') }}">Add New Vendor</a>
                    ...
                    <tbody>
                        ...
                        @foreach ($vendors as $key => $user)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('vendor.switch.toggle') }}" method="POST" style="height: 34px;">
                                        @csrf
