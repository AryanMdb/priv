<nav class="sidebar sidebar-offcanvas overflow-auto h-100" id="sidebar">
  ...
  <ul class="nav">
    ...
    <li class="nav-item">
      ...
      <div class="collapse {{ request()->routeIs('category.index', 'subcategory.index') ? 'show' : '' }}" id="auth">
        <ul class="nav flex-column sub-menu"> 
          <li class="nav-item {{ request()->routeIs('category*') ? 'active' : '' }}"> <a class="nav-link" href="{{route('category.index')}}"> Category </a></li>
          <li class="nav-item {{ request()->routeIs('subcategory*') ? 'active' : '' }}"> <a class="nav-link" href="{{route('subcategory.index')}}"> Subcategory </a></li>
        </ul>
      </div>
    </li>
    ...
    <li class="nav-item {{ request()->routeIs('cms*') ? 'active' : '' }}">
    ...
    <li class="nav-item {{ request()->routeIs('subadmins*') ? 'active' : '' }}">
      <a class="nav-link" href="{{route('subadmins.index')}}">
    ...
    <li class="nav-item">
      ...
      <div class="collapse {{ request()->routeIs('changepassword', 'store_location.view') ? 'show' : '' }}" id="auth1">
        <ul class="nav flex-column sub-menu"> 
          <li class="nav-item {{ request()->routeIs('changepassword') ? 'active' : '' }}"> <a class="nav-link" href="{{ route('changepassword') }}">Change Password</a></li>
          <li class="nav-item {{ request()->routeIs('store_location.view') ? 'active' : '' }}"> <a class="nav-link" href="{{ route('store_location.view') }}">Privykart Store Location</a></li>
          <li class="nav-item {{ request()->routeIs('minimum_order') ? 'active' : '' }}"> <a class="nav-link" href="{{ route('min_order') }}">Minimum Order</a></li>
          <li class="nav-item"> 
