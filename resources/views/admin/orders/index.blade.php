            ...
            <div class="col-xl-7 col-md-12 col-12 w-100 d-flex justify-content-end mt-3">
                <div class="d-flex w-100">
                    ...
                    <a class="bl_btn align-items-center d-flex justify-content-center mb-0 mx-0 w-100"
                        href="{{ route('export-orders') }}">Download Excel</a>
                    {{-- <button id="deleteSelected" style="display: none;" class="btn btn-danger mb-1">Delete
                        Selected</button> --}}
                </div>
            </div>
        </div>
                        ...
                        <td>
                            <form action="{{ route('order.assign-subadmin', $order->id) }}" method="POST"
                                ...
                                <select class="assign_subadmin w-100" name="role_id[]" multiple="multiple">
                                    ...
                                    <option value="{{ $role->id }}" {{ in_array($role->id, (array)
